...
![Subject](https://img.shields.io/badge/Asignatura-Fullstack__2-blue.svg)
...
| Nombre | Rol | Perfil |
| :--- | :--- | :--- |
| **Thomas Escobar** | Desarrollador | [@ThomassEscobar](https://github.com/ThomassEscobar) |
| **Matias Pavez** | Desarrollador | [@Fimchart](https://github.com/Fimchart) |
...
| `feature/*` | Funcionalidades específicas (ej. `feature/login`, `feature/carrito`). | `Ramas de trabajo` |
